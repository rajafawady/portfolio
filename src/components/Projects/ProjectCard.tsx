      ...
      <CardHeader className="space-y-2">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between relative">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                <h3 className="text-2xl font-bold pr-24 text-gray-900 dark:text-gray-100">{project.title}</h3>
              </div>
            </div>
          ...
          <img
            ...
            alt={project.title}
            className="w-full sm:w-24 h-auto sm:h-24 rounded-lg object-cover mt-4 sm:mt-0 sm:ml-4 flex-shrink-0"
          />
        </div>
      </CardHeader>
