export const userData = {
  ...
  experience: [
    ...
    },
    {
      ...
      highlights: "Developed responsive websites with integrated backend functionalities, optimized the performance of web applications, mentored fellow interns by providing guidance, conducting code reviews, and fostering a collaborative learning environment."
    }
],
  education: [
    {
